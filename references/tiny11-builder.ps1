## This file is sourced from  https://github.com/ntdevlabs/tiny11builder/blob/main/tiny11maker.ps1
## It is being used for inspiration on powershell techniques to remove (and re-remove) windows components
